...
Route::post('/', 'LoginController@submitlogin')->name('submitlogin');
        ...
        Route::group(['middleware'=>'isActive'], function() {
            Route::middleware(['CheckStatus'])->group(function () {
                Route::middleware(['Tfa'])->group(function () {
                    ...
                    Route::get('debug', 'UserController@debug')->name('user.debug');
                    //PWA
                    Route::get('appwallet', 'UserController@appwallet')->name('user.appwallet');
                    Route::get('appwithdraw', 'UserController@appwithdraw')->name('user.appwithdraw');
                    Route::get('appprofile', 'UserController@appprofile')->name('user.appprofile');
                    Route::get('appdeposite', 'UserController@appdeposite')->name('user.appdeposite');
                    Route::get('appkyc', 'UserController@appkyc')->name('user.appkyc');
                    Route::get('appsupport', 'UserController@appsupport')->name('user.appsupport');
