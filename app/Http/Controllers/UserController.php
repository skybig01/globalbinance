...
{
    header("Location: /dashboard"); // Replace "/dashboard" with the actual URL of your dashboard page
    exit;
    ...
    {
        $data['title']='App';
        return view('user.appprofile', $data);
    }
    ...
    public function appwallet()
    {
        $data['title']='App Wallet';
         return view('user.appwallet', $data);

    }

    public function appwithdraw()
    {
        $data['title']='Withdraw';
         return view('user.appwithdraw', $data);
    ...
    {
        $data['title']='Support';
         return view('user.appsupport', $data);

    }

    public function appkyc()
    {
        $data['title']='KYC';
         return view('user.appkyc', $data);

    }
    public function appdeposite()
    {
        $data['title']='Deposite';
         return view('user.appdeposite', $data);
